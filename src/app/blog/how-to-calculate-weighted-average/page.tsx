    ...
    <>
      ...
      <div className="container-main py-8">
        ...
        <article className="prose-custom">
          ...
          <nav className="my-8 p-5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-3">Table of Contents</h2>
          ...
          <div className="my-6 p-5 rounded-xl bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-800 text-center">
            <p className="text-lg font-bold text-indigo-900 dark:text-indigo-200 mb-0">
