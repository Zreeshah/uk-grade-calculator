...
export default function Header() {
 ...
 key={item.href}
 href={item.href}
 className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 rounded-lg hover:bg-slate-100 transition-colors"
 >
 {item.label}
 </Link>
 ))}
 ...
 className="block px-6 py-3 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-slate-50"
 >
 {item.label}
 </Link>
 ))}
